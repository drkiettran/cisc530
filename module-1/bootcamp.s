...
bootcamp:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d 4a 01 00 00 	lea    0x14a(%rip),%rdi        # 11f2 <main>
...
0000000000001169 <basic_00>:
    ...
    1181:	c7 45 f0 0a 00 00 00 	movl   $0xa,-0x10(%rbp)
    1188:	48 8d 05 7f 0e 00 00 	lea    0xe7f(%rip),%rax        # 200e <_IO_stdin_used+0xe>
    118f:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1193:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1196:	89 c6                	mov    %eax,%esi
    1198:	48 8d 3d 7d 0e 00 00 	lea    0xe7d(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    119f:	b8 00 00 00 00       	mov    $0x0,%eax
    11a4:	e8 c7 fe ff ff       	callq  1070 <printf@plt>
    11a9:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11ac:	89 c6                	mov    %eax,%esi
    11ae:	48 8d 3d 6d 0e 00 00 	lea    0xe6d(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    ...
    11c6:	48 8d 3d 5b 0e 00 00 	lea    0xe5b(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    ...
    11e3:	48 8d 3d 24 0e 00 00 	lea    0xe24(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    11ea:	e8 71 fe ff ff       	callq  1060 <puts@plt>
    11ef:	90                   	nop
    11f0:	c9                   	leaveq 
    11f1:	c3                   	retq   
...
00000000000011f2 <main>:
    ...
    11fa:	48 8d 3d 35 0e 00 00 	lea    0xe35(%rip),%rdi        # 2036 <_IO_stdin_used+0x36>
    1201:	e8 5a fe ff ff       	callq  1060 <puts@plt>
    1206:	b8 00 00 00 00       	mov    $0x0,%eax
    120b:	e8 59 ff ff ff       	callq  1169 <basic_00>
